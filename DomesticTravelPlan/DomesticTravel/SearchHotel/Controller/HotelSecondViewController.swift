...
class HotelSecondViewController: DomesticBaseViewController {

    @IBOutlet var views: HotelSecondViews!
    ...
    private func setupCollection() {
        views.dismissBtn.addTarget(self, action: #selector(previousBack), for: .touchUpInside)
...
extension HotelSecondViewController: UICollectionViewDelegate, UICollectionViewDataSource, UICollectionViewDelegateFlowLayout {
    ...
    func collectionView(_ collectionView: UICollectionView, cellForItemAt indexPath: IndexPath) -> UICollectionViewCell {
        if indexPath.section == views.mCollectionView.numberOfSections - 1 {
    ...
    func collectionView(_ collectionView: UICollectionView, layout collectionViewLayout: UICollectionViewLayout, insetForSectionAt section: Int) -> UIEdgeInsets {
        if section == views.mCollectionView.numberOfSections - 1 {
...
extension HotelSecondViewController: HotelAddressProtocol {
