...
class MenuItemView: UIView {
    ...
    func setUpMenuItemView(_ menuItemWidth: CGFloat, menuScrollViewHeight: CGFloat, indicatorHeight: CGFloat, separatorPercentageHeight: CGFloat, separatorWidth: CGFloat, separatorRoundEdges: Bool, menuItemSeparatorColor: UIColor, menuItemIsHiddenSeparator: Bool) {
        ...
        let y = ((menuItemSeparator?.frame.height ?? 0.0) - 23.0) / 2
        let view = UIView(frame: CGRect(x: 0, y: y, width: 1.0, height: 23))
        view.backgroundColor = UIColor(0x464646)

        menuItemSeparator?.isHidden = menuItemIsHiddenSeparator
        menuItemSeparator?.addSubview(view)
